                    ...
                    <div class="card card-details">
                        ...
                        @if ($item->galleries->count())
                            ...
                            <div class="xzoom-container">
                                ...
                                class="xzoom" 
                                id="xzoom-default" x-original="{{Storage::url($item->galleries->first()->image)}}">
                            </div>
                ...
                <div class="col-lg-4">
                    <div class="card card-details card-right">
                        ...
                        <div class="members my-2">
                            <img src="{{url('frontend/images/member-1.jpg')}}"
                             class="member-image mr-1">
                             <img src="{{url('frontend/images/member-2.jpg')}}"
                             class="member-image mr-1">
                             <img src="{{url('frontend/images/member-3.jpg')}}"
                             class="member-image mr-1">
                             <img src="{{url('frontend/images/member-4.jpg')}}"
                             class="member-image mr-1">
                             <img src="{{url('frontend/images/member-5.jpg')}}"
                             class="member-image mr-1">
                             <img src="{{url('frontend/images/member-6.jpg')}}"
                             class="member-image mr-1">
                        </div>
                        <hr />
                        ...
                        <table class="trip-information">
                            <tr>
                                <th width="50%">Date of Deparuter</th>
                    ...
                    <div class="join-container">
                        ...
                        @endauth
                        @guest
                        <a href="{{route('login')}}" class="btn-block btn-join-now mt-3 py-2 text-center">
                            Login / Register
                        </a>
                        @endguest
                    </div>
