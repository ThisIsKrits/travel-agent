...
<main>
    ...
    <div class="section-popular-content" id="popularContent">
        <div class="container">
                ...
                <div class="col-sm-6 col-md-6 col-lg-4">
                    <div class="card card-testimonial text-center">
                        <div class="testimonial-content">
                            <img src="frontend/images/testimonial1.png" alt="user"
                            class="mb-4 rounded-circle">
                            <h3 class="mb-4">Gerard Tony</h3>
                            <p class="testimonial">
                ...
                <div class="col-sm-6 col-md-6 col-lg-4">
                    <div class="card card-testimonial text-center">
                        <div class="testimonial-content">
                            ...
                            class="mb-4 rounded-circle">
                            <h3 class="mb-4">Antony Samuel</h3>
                            <p class="testimonial">
                                "Mountains are a very 
                                amazing creation
                                of God"
                            </p>
                        </div>
                ...
                <div class="col-sm-6 col-md-6 col-lg-4">
                    <div class="card card-testimonial text-center">
                        <div class="testimonial-content">
                            ...
                            class="mb-4 rounded-circle">
                            <h3 class="mb-4">Selfy Samara</h3>
                            <p class="testimonial">
                                "As the ocean is never 
                                full of water, so is the heart 
                                never full of love”
                            </p>
                        </div>
                        <hr>
